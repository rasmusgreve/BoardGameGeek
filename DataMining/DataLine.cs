...
namespace DataMiningIndividual
{
    ...
    public class DataLine
    {
        ...
        public static DataLine ParseFixed(string[] data, string[] names)
        {
            ...
            //result.hashStrings["str "+names[2]] = "year_published " + data[2];    //year_published
            ...
            //result.hashStrings["str " + names[3]] = "min_players " + data[3];     //min_players
            ...
            //result.hashStrings["str " + names[4]] = "max_players " + data[4];       //max_players
            //result.hashStrings["str " + names[5]] = "playingtime " + data[5];         //playingtime
            ...
            //result.hashStrings["str " + names[8]] = "average_rating " + data[8];       //average_rating
